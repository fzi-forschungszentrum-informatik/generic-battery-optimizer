...
def test_scenarios(data):
    ...
    for day, input_data in days.items():
        ...
        hp = HeatPump(
            ...
            blocking_hours=house_data["BLOCKING_HOURS"],
            limited_energy_hours=house_data["LIMITED_ENERGY_HOURS"],
            warm_water_periods=house_data["WARM_WATER_PERIOD"],
            surface_building=house_data["SURFACE_BUILDING"],
            ...
            min_electric_consumption_hp=house_data[
                "MIND_ELECTRIC_CONSUMPTION_HP"
            ],
            max_electric_consumption_hr=house_data[
                "MAX_ELECTRIC_CONSUMPTION_HR"
            ],
            min_electric_consumption_hr=house_data[
                "MIND_ELECTRIC_CONSUMPTION_HR"
            ],
